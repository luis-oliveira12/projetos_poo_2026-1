...
import ufpb.dcx.atividade3.*; // Puxa os ficheiros da outra pasta
...
public class TestaSistemaAmigo {
    public static void main(String[] args) {
        ...
        sistema.enviarMensagemParaAlguem("Oi José, adivinha quem é?", "maria@email.com", "jose@email.com", true);
        sistema.enviarMensagemParaTodos("Feliz Amigo Secreto a todos!", "maria@email.com", true);

        System.out.println("--- Mensagens Anónimas Encontradas ---");
